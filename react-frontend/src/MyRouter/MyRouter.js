...
import SingleItinerariesPage from "../components/app_components/ItinerariesPage/SingleItinerariesPage";
import ItineraryProjectLayoutPage from "../components/app_components/ItinerariesPage/ItineraryProjectLayoutPage";
import SingleItineraryCitiesPage from "../components/app_components/ItineraryCitiesPage/SingleItineraryCitiesPage";
import ItineraryCityProjectLayoutPage from "../components/app_components/ItineraryCitiesPage/ItineraryCityProjectLayoutPage";
import SingleDayPlansPage from "../components/app_components/DayPlansPage/SingleDayPlansPage";
import DayPlanProjectLayoutPage from "../components/app_components/DayPlansPage/DayPlanProjectLayoutPage";
import SingleActivitiesPage from "../components/app_components/ActivitiesPage/SingleActivitiesPage";
import ActivityProjectLayoutPage from "../components/app_components/ActivitiesPage/ActivityProjectLayoutPage";
import SingleBookmarksPage from "../components/app_components/BookmarksPage/SingleBookmarksPage";
import BookmarkProjectLayoutPage from "../components/app_components/BookmarksPage/BookmarkProjectLayoutPage";
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/itineraries/:singleItinerariesId" exact element={<SingleItinerariesPage />} />
<Route path="/itineraries" exact element={<ItineraryProjectLayoutPage />} />
<Route path="/itineraryCities/:singleItineraryCitiesId" exact element={<SingleItineraryCitiesPage />} />
<Route path="/itineraryCities" exact element={<ItineraryCityProjectLayoutPage />} />
<Route path="/dayPlans/:singleDayPlansId" exact element={<SingleDayPlansPage />} />
<Route path="/dayPlans" exact element={<DayPlanProjectLayoutPage />} />
<Route path="/activities/:singleActivitiesId" exact element={<SingleActivitiesPage />} />
<Route path="/activities" exact element={<ActivityProjectLayoutPage />} />
<Route path="/bookmarks/:singleBookmarksId" exact element={<SingleBookmarksPage />} />
<Route path="/bookmarks" exact element={<BookmarkProjectLayoutPage />} />
