...
import seederData from "./activities.seeder.json";
...
const ActivitiesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ActivitiesSeederDialogComponent);
