...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Payment Date</label><p className="m-0 ml-3" ><Calendar id="paymentDate" value={new Date(_entity?.paymentDate)} disabled={true} hourFormat="24"  /></p></div>
