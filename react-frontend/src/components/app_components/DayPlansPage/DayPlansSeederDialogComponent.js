...
import seederData from "./dayPlans.seeder.json";
...
const DayPlansSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DayPlansSeederDialogComponent);
