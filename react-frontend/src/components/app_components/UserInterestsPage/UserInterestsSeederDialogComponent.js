...
import seederData from "./userInterests.seeder.json";
...
const UserInterestsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserInterestsSeederDialogComponent);
