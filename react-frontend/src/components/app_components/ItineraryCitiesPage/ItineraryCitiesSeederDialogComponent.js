...
import seederData from "./itineraryCities.seeder.json";
...
const ItineraryCitiesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ItineraryCitiesSeederDialogComponent);
