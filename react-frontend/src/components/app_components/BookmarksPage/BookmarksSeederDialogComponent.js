...
import seederData from "./bookmarks.seeder.json";
...
const BookmarksSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BookmarksSeederDialogComponent);
