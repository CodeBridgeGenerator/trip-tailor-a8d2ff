...
import seederData from "./interests.seeder.json";
...
const InterestsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(InterestsSeederDialogComponent);
