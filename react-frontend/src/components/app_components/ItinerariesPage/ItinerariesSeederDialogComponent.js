...
import seederData from "./itineraries.seeder.json";
...
const ItinerariesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ItinerariesSeederDialogComponent);
