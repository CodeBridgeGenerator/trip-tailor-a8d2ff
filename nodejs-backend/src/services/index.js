...
const itineraryCities = require("./itineraryCities/itineraryCities.service.js");
const dayPlans = require("./dayPlans/dayPlans.service.js");
...
module.exports = function (app) {
  ...
  app.configure(itineraryCities);
  app.configure(dayPlans);
